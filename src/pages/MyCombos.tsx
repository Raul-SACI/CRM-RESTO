            ...
            >
              ...
              <div className="mt-6 space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                <button
                  ...
                  className="w-full bg-[#009ee3] hover:bg-[#008cc8] text-white py-3.5 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all shadow-md shadow-sky-500/10 flex items-center justify-center gap-2 cursor-pointer border-none disabled:opacity-50"
                >
                ...
                <div className="flex items-center gap-3 my-4">
                  ...
                  <span className="text-[8px] font-black uppercase tracking-widest text-slate-400">O con Tarjeta ficticia</span>
                  <div className="h-[1px] bg-slate-100 dark:bg-slate-800 flex-1" />
                </div>

                <form onSubmit={handlePayWithMockCard} className="space-y-3">
                  <div className="space-y-1">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Número de Tarjeta</label>
                    <input 
                      required
                      maxLength={16}
                      placeholder="4517 8493 0041 3844"
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Nombre en Tarjeta</label>
                    <input 
                      required
                      placeholder="JUAN PEREZ"
                      className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-xs outline-none focus:border-love text-ink dark:text-white uppercase"
                      value={cardForm.name}
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Código CVC</label>
                      <input 
                        required
                        maxLength={3}
                        placeholder="114"
                  ...
                  <div className="flex gap-2 pt-4">
                    <button 
                      ...
                      className="flex-1 bg-slate-100 dark:bg-slate-800 text-slate-500 py-3 rounded-xl font-bold text-[9px] uppercase tracking-widest hover:bg-slate-200 cursor-pointer border-none"
                    >
                      Cancelar
                    </button>
                    <button 
                      ...
                      className="flex-[2] bg-love text-white py-3 rounded-xl font-black text-[9px] uppercase tracking-widest shadow-lg shadow-love/30 flex items-center justify-center gap-1.5 cursor-pointer border-none"
                    >
                      {paymentProcessing ? (
                        <>Procesando...</>
                      ) : (
