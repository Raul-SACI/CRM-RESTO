...
export function Waiter() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8 bg-ash p-6 rounded-3xl border border-white/5 shadow-bento">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-love rounded-lg flex items-center justify-center font-bold text-xl uppercase shadow-lg shadow-love/30">M</div>
          <div>
            <h2 className="text-lg font-bold tracking-tight uppercase leading-none">Carga <span className="text-love">Mozo</span></h2>
            <p className="text-[10px] uppercase tracking-widest text-slate-500 mt-1">Suma puntos a clientes</p>
          </div>
        </div>
        <button 
          onClick={() => setShowScanner(!showScanner)}
          className={cn(
            "p-3 rounded-2xl transition-all border flex items-center gap-2 text-[8px] font-bold uppercase tracking-widest",
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-100 border-none rounded-2xl py-5 pl-14 pr-4 text-2xl font-black outline-none focus:ring-2 focus:ring-love transition-all text-black placeholder:text-slate-200"
                  value={dni}
            ...
            <AnimatePresence mode="wait">
              {client ? (
                ...
                >
                  ...
                  <div className="space-y-2">
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest pl-2">Monto consumo</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="1000"
                        autoFocus
                        className="w-full bg-slate-100 border-none rounded-2xl py-8 pl-12 pr-6 text-5xl font-black outline-none focus:ring-4 focus:ring-love/10 transition-all text-black text-center"
                        value={amount}
